...
CONSTANTS start-cards   
(***************************************************************************)
(* We next declare the specification's variables.                          *)
(***************************************************************************)
VARIABLES fields      \* The numbered fields aof the game board
          mrx         \* The actual position on the board
          round       
          start-cards 


TypeOK == /\ fields  \in 1..199
          /\ mrx in [position : 1..199,
                     ]
          /\ round \in 1..22
          /\ start-cards 
